...
LABEL org.label-schema.license="GPL-2.0" \
      org.label-schema.vcs-url="https://github.com/Jamamel/jama_r-base" \
      org.label-schema.vendor="Jamadocker" \
      maintainer="Juan Hernandez <jamamel@gmail.com>"
...
RUN apt-get update \
  ...
  && Rscript -e "install.packages(c('littler', 'docopt', 'renv'), repo = '$CRAN')" \
